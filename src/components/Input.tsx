...
const Input = ({ type = "text", name, placeholder, label, def, props }: { def?: string, type: string, name: string, placeholder: string, label: string, props?: HTMLAttributes<HTMLInputElement> }) => {
    return (
        <>
